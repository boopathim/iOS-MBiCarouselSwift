...
// All the files related to iCarousel is under copyright of Nick Lockwood and charcaol design. Im using the library files and make to working in Swift
...
// iPhone  and iPad Support = All Orientations and all ScreenSizes, Shapes, changing Designs instantly with PickerView Support - Provided by MaxymusBoopathy

// Default support contains only icarousel - I have added the reflection view
