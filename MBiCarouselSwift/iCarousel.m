...
/*Library Edited on 8-6-2015 by Boopathi M - Replace the ReflectionView with the UIView  in the  - (ReflectionView *)dequeueItemView
 method to revert it back*/
- (ReflectionView *)dequeueItemView
{
    ReflectionView *view = [_itemViewPool anyObject];
    if (view)
    {
